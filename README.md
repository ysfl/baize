...
当前测试版发布在 GitHub Releases 的 Pre-release 列表中；版本检测以 [最新版本清单](releases/latest.json) 为准。当前镜像为 [中心服务 `ghcr.io/ysfl/baize-server:0.2.0`](https://github.com/users/ysfl/packages/container/package/baize-server) 与 [控制台 `ghcr.io/ysfl/baize-web:0.1.38`](https://github.com/users/ysfl/packages/container/package/baize-web)。
