...
The current beta is published as a GitHub Pre-release; update checks use the [latest manifest](releases/latest.json). Current images are [server `ghcr.io/ysfl/baize-server:0.1.37`](https://github.com/users/ysfl/packages/container/package/baize-server) and [console `ghcr.io/ysfl/baize-web:0.1.37`](https://github.com/users/ysfl/packages/container/package/baize-web).
